  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "Gratis",
      annualPrice: "Gratis",
      description: "Comienza a ganar dinero completando tareas.",
      features: [
        "Acceso a tareas básicas (Novice level)",
        "Wallet virtual para recibir pagos",
        "Sistema de scoring y progresión",
        "Retiros desde $10 USD",
        "Soporte por email",
      ],
      buttonText: "Unirme como Worker",
      buttonClass:
        "bg-zinc-300 shadow-[0px_1px_1px_-0.5px_rgba(16,24,40,0.20)] outline outline-0.5 outline-[#1e29391f] outline-offset-[-0.5px] text-gray-800 text-shadow-[0px_1px_1px_rgba(16,24,40,0.08)] hover:bg-zinc-400",
    },
    {
      name: "Requester Starter",
      monthlyPrice: "$99",
      annualPrice: "$79",
      description: "Para empresas que necesitan procesar datos.",
      features: [
        "Hasta 10,000 tareas mensuales",
        "QC automático con ML (SageMaker)",
        "Majority voting (3 workers por task)",
        "10% de honeypot tasks incluidos",
    ...
    },
    {
      ...
      features: [
        ...
        "Custom ML models para QC",
        "Dedicated account manager",
        "SLA garantizado (99.9% uptime)",
        "Seguridad enterprise-grade",
        "Batch operations y scheduled tasks",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px] text-balance">
            Planes para Workers y Requesters
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight text-pretty">
            Gana dinero completando tareas o publica proyectos para procesar tus datos con <br /> nuestra red global de
            workers verificados.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              <div className="self-stretch flex flex-col justify-start items-start gap-8">
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-1">
                  <div className="flex justify-start items-center gap-1.5">
                    ...
                    >
                      {plan.name === "Worker" || plan.name === "Enterprise" ? (
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Worker" ? "text-gray-800" : plan.name === "Requester Starter" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Worker" ? "Incluye:" : "Todo en Worker +"}
              </div>
